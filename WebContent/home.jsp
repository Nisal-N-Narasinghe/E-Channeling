...
<body id="page-top">
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img style ="clip-path:circle()" class="masthead-avatar mb-5" src="pimages/<%=session.getAttribute("img") %>"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To E-Channeling <%=session.getAttribute("name") %></h1>
			<!-- Icon Divider-->
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto">
						...
						<p align="center"><img class="img-fluid" src="images/counseling.png"
							alt="..." /></p>
							<h4 style="text-align:center">Counseling</h4>
					</div>
				</div>
				<!-- Portfolio Item 4-->
