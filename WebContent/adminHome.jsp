...
<body id="page-top">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="booking-list.jsp">Bookings</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">LAB Reports</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Counseling</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<!-- Masthead-->
	<header style="background-color: #8fd3fe">
	<br><br><br><br><br>
	<!-- Icon Divider-->
		...
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="images/adminimg.png"
				alt="..." />
			<!-- Masthead Heading-->
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small> Admin &copy; All Rights Reserved</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
